...
def main():
    ...
    checks = {
        ...
        "admin nav order": 'return isAdmin() ? ["dashboard", "users", "reviews", "projects", "assets", "deploy"]' in js,
        "admin internal views": '["dashboard", "projects", "assets", "reviews", "reports", "settings", "users", "deploy", "logs", "account"]' in js,
        "admin pages redirects": 'if (isAdmin() && view === "pages") view = "deploy";' in js,
        "project assignment panel": 'id="projectAssignmentPanel"' in html and "openProjectAssignmentPanel" in js,
        ...
        "teacher nav order": 'const teacherViewOrder = ["pages", "assets", "account"]' in js,
        "teacher nav labels": 'const teacherViews = {' in js and 'assets: ["素材中心"' in js,
        ...
        "teacher console title": 'canReview() ? "数字展示管理后台" : "门户资料工作台"' in js,
        ...
        "teacher hides manual controls": '"newPage", "newLegacyPage", "pageStatusFilter", "pageModuleFilter", "pageSearch", "exportModuleCoverage", "exportModuleGaps"' in js,
