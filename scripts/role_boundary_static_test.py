...
def main():
    ...
    checks = {
        ...
        "admin nav order": 'return isAdmin() ? ["dashboard", "users", "projects", "pages", "assets", "reviews", "deploy", "logs", "account"]' in js,
        "department nav order": "canReview() ? reviewerViewOrder : teacherViewOrder" in js,
        "reviewer nav excludes global admin": 'const reviewerViewOrder = ["dashboard", "projects", "pages", "assets", "reviews", "account"]' in js,
