...
CHECKS = [
    ...
    (
        ...
        [
            ...
            "scripts/display_detail_layout_static_test.py",
            "scripts/blueprint_logo_layout_static_test.py",
            "scripts/topic_external_links_static_test.py",
            "scripts/navigation_restore_static_test.py",
            ...
            "scripts/role_boundary_static_test.py",
            "scripts/teacher_lowcode_simplified_static_test.py",
            "scripts/teacher_pages_layout_static_test.py",
            "scripts/teacher_lowcode_record_actions_static_test.py",
            "scripts/teacher_report_fetch_static_test.py",
            "scripts/lowcode_template_quality_export_static_test.py",
            "scripts/lowcode_template_import_export_static_test.py",
            "scripts/management_report_exports_static_test.py",
            "scripts/content_quality_report_test.py",
            "scripts/asset_archive_report_test.py",
            "scripts/department_admin_scope_test.py",
            "scripts/lowcode_progress_report_test.py",
            "scripts/unity_model_fallback_test.py",
    ...
    ("display_detail_layout_static", [sys.executable, "scripts/display_detail_layout_static_test.py"]),
    ("blueprint_logo_layout_static", [sys.executable, "scripts/blueprint_logo_layout_static_test.py"]),
    ("topic_external_links_static", [sys.executable, "scripts/topic_external_links_static_test.py"]),
    ("navigation_restore_static", [sys.executable, "scripts/navigation_restore_static_test.py"]),
    ...
    ("role_boundary_static", [sys.executable, "scripts/role_boundary_static_test.py"]),
    ("teacher_lowcode_simplified_static", [sys.executable, "scripts/teacher_lowcode_simplified_static_test.py"]),
    ("teacher_pages_layout_static", [sys.executable, "scripts/teacher_pages_layout_static_test.py"]),
    ("teacher_lowcode_record_actions_static", [sys.executable, "scripts/teacher_lowcode_record_actions_static_test.py"]),
    ("teacher_report_fetch_static", [sys.executable, "scripts/teacher_report_fetch_static_test.py"]),
    ("lowcode_template_quality_export_static", [sys.executable, "scripts/lowcode_template_quality_export_static_test.py"]),
    ("lowcode_template_import_export_static", [sys.executable, "scripts/lowcode_template_import_export_static_test.py"]),
    ("management_report_exports_static", [sys.executable, "scripts/management_report_exports_static_test.py"]),
    ...
    ("department_admin_scope", [sys.executable, "scripts/department_admin_scope_test.py"]),
    ("lowcode_progress_report", [sys.executable, "scripts/lowcode_progress_report_test.py"]),
    ("unity_model_fallback", [sys.executable, "scripts/unity_model_fallback_test.py"]),
